//
//  CardDetailOptionModalView.swift
//  Albaid
//
...
final class CardDetailOptionModalView: BaseView {
    ...
    private(set) var endButton = BaseButton().then {
        $0.setOptionButton(optionImage: AlbaidButton.end.withTintColor(.albaidGray40), title: "근로계약 종료하기")
    }
    ...
    override func makeConstraints() {
        ...
        deleteButton.snp.makeConstraints {
            $0.top.equalTo(endButton.snp.bottom).offset(20)
            $0.horizontalEdges.equalToSuperview().inset(20)
        }
    }
}
